...
const DateTimeFormField = ({ name, label = null, required = false, disabled, error = null, className = '', ...rest }) => {
  ...
  return (
    <Container className={className}>
      ...
      <CustomFormItem name={name}>
        <CustomInput onBlur={() => setBlur(true)} disabled={disabled} type='datetime-local' {...rest} />
      </CustomFormItem>
